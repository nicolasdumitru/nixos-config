...
in
{
  ...
  # Packages remain system-owned on NixOS. Standalone Home Manager can add a
  # platform-specific package policy later without changing file deployment.
  home.packages = [ ];
  ...
  xdg.configFile = {
    ...
    "nvim/init.lua" = managed ../dotfiles/.config/nvim/init.lua;
